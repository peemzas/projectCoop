                            ...
                            <div class="form-inline">
                                ...
                                <div class="col-sm-3 input-group">
                                    ...
                                    <span class="input-group-addon">
                                        <i class="glyphicon glyphicon-search" style="cursor: pointer; height: 20px;" onclick="listSearchPaper()"></i>
                                    </span>
                                </div>
            ...
            <div class="row">
                <div class="row" id="btnSearch">
                    <div class="col-md-12 text-center">
                        ...
                        <button id="btnExamRecordSearchClearInput" class="btn btn-default btn btn-sm" type="button" style="background-color: rgba(193, 193, 198, 0.83); color: #000000;">ล้างข้อมูล</button>
                    </div>
                </div>
            </div>
        </div>
