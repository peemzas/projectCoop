      ...
      <table class = "table table-striped">
        ...
        <tbody align="center">
          <tr>
            ...
            <td>EmployeeA</td>
            <td>เปิด</td>
            <td><a href = "/TDCS/editButtonOnPageEditPapers"><button class = "btn btn-warning" type = "button" data-toggle = "modal" data-target = "#editQuestionModal"><span class = "glyphicon glyphicon-pencil"></span></button></a></td>
            <td><button class = "btn btn-info" type = "button"><span class = "glyphicon glyphicon-book"></span></button></td>
          </tr>
          <tr>
            <td>11112</td>
            <td>แบบทดสอบวัดความรู้หลังการอบรม</td>
            <td>19/1/2558</td>
            <td>Developer Trainee</td>
            <td>50</td>
            <td>EmployeeB</td>
