    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <div class="form-horizontal">
          ...
          <div class="form-group">
            <div class="row col-md-12">
              <label class="col-md-3 control-label" style="padding-left: 0px;padding-right: 0px"><small>ชื่อเล่น</small></label>
              <div class="col-md-2">
                <input id="nickname" name="username" class="form-control" value="${user.nickName}" onkeypress="return isThai(event)" readonly="true"/>
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="row col-md-12">
              <label class="col-md-3 control-label" style="padding-left: 0px;padding-right: 0px"><small>สังกัด</small></label>
              <div class="col-md-4">
                <input name="username" class="form-control" value="${user.company.compName}" readonly="true" />
              </div>
              <label for="enLname" class="col-md-1 control-label" style="padding: 7px 0px 7px 0px;"><small>แผนก</small></label>
              <div class="col-md-4">
                <input type="hidden" id="sectionIdHiden" value="${user.sectionPosition.sectionId}" />
                <input class="form-control" value="${user.sectionPosition.section.sectionName}" readonly="true"/>
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="row col-md-12">
              <label class="col-md-3 control-label" style="padding-left: 0px;padding-right: 0px"><small>ตำแหน่ง</small></label>
              <div class="col-md-4">
                <input name="username" class="form-control" value="${user.sectionPosition.position.posiName}" readonly="true" />
                <input type="hidden" id="jobIdHiden" value="${user.spId}"/>
              </div>
              <label for="enLname" class="col-md-1 control-label" style="padding: 7px 0px 7px 0px;"><small>ทีม</small></label>
              <div class="col-md-4">
          ...
          <div class="form-group">
            <div class="row col-md-12">
              <label class="col-md-3 control-label" style="padding-left: 0px;padding-right: 0px"><small>เริ่มทำงาน</small></label>
                <div class="col-md-4">
                  <div class='input-group date' id='dpStartWork'>
                    <input id="startWork" type='text' class="form-control" readonly="true" value="${user.startWork}"/>
                  </div>
                </div>
                  <label class="col-md-1 control-label" style="padding-right: 0px;"><small>รวม</small></label>
